...
SET "MAIN_OUTPUT_DIR=%~dp0Parallel_Run_Logs\thread_count_9"
...
SET "INSTANCE7_SOURCE_DIR=C:\Local_Data\ABC\ABC_parsed_files\ABC_chunk_benchmark"
SET "INSTANCE7_TARGET_DIR=C:\Local_Data\ABC\ABC_statistics\benchmarks\MultiThreadBatch\%INSTANCE7_ID%"
...
START "%INSTANCE7_ID% Process" /B "%EXECUTABLE_PATH%" "%INSTANCE7_APP_LOG%" "%INSTANCE7_SOURCE_DIR%" "%INSTANCE7_TARGET_DIR%" > "%INSTANCE7_STDOUT_LOG%" 2> "%INSTANCE7_STDERR_LOG%"
echo.

REM --- Instance 8 ---
SET "INSTANCE8_ID=Instance008"
SET "INSTANCE8_APP_LOG=%MAIN_OUTPUT_DIR%\%INSTANCE8_ID%_app_internal.log"
SET "INSTANCE8_SOURCE_DIR=C:\Local_Data\ABC\ABC_parsed_files\ABC_chunk_benchmark"
SET "INSTANCE8_TARGET_DIR=C:\Local_Data\ABC\ABC_statistics\benchmarks\MultiThreadBatch\%INSTANCE8_ID%"
...
START "%INSTANCE8_ID% Process" /B "%EXECUTABLE_PATH%" "%INSTANCE8_APP_LOG%" "%INSTANCE8_SOURCE_DIR%" "%INSTANCE8_TARGET_DIR%" > "%INSTANCE8_STDOUT_LOG%" 2> "%INSTANCE8_STDERR_LOG%"
echo.

REM --- Instance 9 ---
SET "INSTANCE9_ID=Instance009"
SET "INSTANCE9_APP_LOG=%MAIN_OUTPUT_DIR%\%INSTANCE9_ID%_app_internal.log"
SET "INSTANCE9_SOURCE_DIR=C:\Local_Data\ABC\ABC_parsed_files\ABC_chunk_benchmark"
SET "INSTANCE9_TARGET_DIR=C:\Local_Data\ABC\ABC_statistics\benchmarks\MultiThreadBatch\%INSTANCE9_ID%"
...
START "%INSTANCE9_ID% Process" /B "%EXECUTABLE_PATH%" "%INSTANCE9_APP_LOG%" "%INSTANCE9_SOURCE_DIR%" "%INSTANCE9_TARGET_DIR%" > "%INSTANCE9_STDOUT_LOG%" 2> "%INSTANCE9_STDERR_LOG%"
echo.
