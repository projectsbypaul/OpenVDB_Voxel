...
SET "MAIN_OUTPUT_DIR=%~dp0Parallel_Run_Logs\job_ABC_chunk_01_run_01_%GLOB_THREAD_COUNT%"
...
SET "GLOB_SOURCE_DIR=C:\Local_Data\ABC\ABC_parsed_files\ABC_chunk_01"
SET "GLOB_TARGET_DIR=C:\Local_Data\ABC\ABC_Datasets\Segmentation\ABC_Chunk_01\ABC_Data_ks_16_pad_4_bw_5_vs_adaptive_n2"
SET "GLOB_JOB_DIR=C:\Local_Data\ABC\ABC_jobs\job_chunk_01_run_01"
