...
SET "GLOB_TARGET_DIR=H:\ABC\ABC_parsed_files\train_chunks\ABC_chunk_03"
SET "GLOB_JOB_DIR=H:\ABC\ABC_jobs\pj_chunk_03"
SET "JOB_TYPE=purge_yaml"
SET "MAIN_OUTPUT_DIR=%~dp0Parallel_Run_Logs\JobController\purge_job_03"
