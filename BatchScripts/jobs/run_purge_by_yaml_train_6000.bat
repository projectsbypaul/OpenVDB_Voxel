...
SET "GLOB_TARGET_DIR=H:\ABC\ABC_Datasets\Segmentation\%DATASET%"
SET "GLOB_JOB_DIR=H:\ABC\ABC_Datasets\Segmentation\purge_jobs\%DATASET%"
SET "JOB_TYPE=purge_yaml"
SET "MAIN_OUTPUT_DIR=%~dp0Parallel_Run_Logs\JobController\pj_%DATASET%"
