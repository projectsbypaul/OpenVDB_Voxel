...
namespace Scripts {
	...
	int run_segmentation_on_vdb(fs::path source, fs::path target, int kernel_size, int padding, int openvdb_threads = 10);
	...
	int run_subdir_to_dataset_rand_aug(fs::path source, fs::path target, std::string subdir_name, int kernel_size, int padding, int bandwidth, double voxel_size, int max_threads=1, int openvdb_threads=1, int timeout_min=5);
	int run_subdir_to_dataset_rand_aug(fs::path source, fs::path target, std::string subdir_name, int kernel_size, int padding, int bandwidth, int n_k_min, int max_threads=1, int openvdb_threads = 1, int timeout_min=5);
